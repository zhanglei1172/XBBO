...
from xbbo.utils.constants import N_TREES


class RandomForestWithInstances(SurrogateModel):
    ...
    def _predict(self, X: np.ndarray,cov_return_type: typing.Optional[str] = 'diagonal_cov') -> typing.Tuple[np.ndarray, np.ndarray]:
